...
Devise.setup do |config|
  ...
  config.omniauth :saml,
                  ...
                  certificate: Base64.strict_decode64(Rails.application.secrets.saml_certificate),
                  private_key: Base64.strict_decode64(Rails.application.secrets.saml_private_key),
